        ...
        <td>
            ...
            if ($tunnelcount > 0) {
                while ($tunnelrow = mysqli_fetch_assoc($rstunnels)) {
                    echo ("                        " . $tunnelrow["tunnelname"] . " (<a href=\"" . $tunnelrow["localproto"] . "://" . $tunnelrow["localhost"] . ":" . $tunnelrow["localport"] . "\">" . $tunnelrow["localproto"] . "://" . $tunnelrow["localhost"] . ":" . $tunnelrow["localport"] . "</a> to " . $tunnelrow["tunnelport"] . ")<br>\n");
                }
            } else {
                echo ("                        None\n");
            }
